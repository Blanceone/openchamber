export const settingsDict = {
  ...
  'settings.page.openwiki.description': "Створюйте й підтримуйте wiki проєкту через OpenWiki з моделлю OpenCode.",
  'settings.openwiki.section.general': "Загальні",
  'settings.openwiki.section.format': "Формат документа",
  'settings.openwiki.enabled.label': "Показувати поверхню Wiki",
  'settings.openwiki.enabled.info': "Якщо вимкнено, Wiki ховається з контекстної панелі.",
  'settings.openwiki.autoReveal.label': "Відкривати Wiki після завдань",
  'settings.openwiki.autoReveal.info': "Після успішної генерації або оновлення відкривати поверхню Wiki.",
  'settings.openwiki.language.label': "Мова wiki",
  'settings.openwiki.language.info': "Необов’язкова локаль BCP-47 для OpenWiki (наприклад uk).",
  'settings.openwiki.model.label': "Модель wiki",
  'settings.openwiki.model.info': "За замовчуванням — поточний вибір OpenCode. Можна обрати іншу авторизовану модель.",
  'settings.openwiki.model.followCurrent': "Як поточна модель OpenCode",
  'settings.openwiki.model.current': "Поточна модель OpenCode: {model}",
  'settings.openwiki.model.none': "Не вибрано",
  'settings.openwiki.noProject': "Відкрийте проєкт, щоб редагувати brief і формат wiki.",
  'settings.openwiki.preset.label': "Предустановка формату",
  'settings.openwiki.preset.info': "Застосування предустановки замінює brief і формат.",
  'settings.openwiki.preset.apply': "Застосувати",
  'settings.openwiki.preset.openwiki-default': "Типовий OpenWiki",
  'settings.openwiki.preset.architecture-module': "Архітектура + модулі",
  'settings.openwiki.preset.api-service': "API / service",
  'settings.openwiki.preset.custom': "Власний",
  'settings.openwiki.brief.label': "Brief (INSTRUCTIONS.md)",
  'settings.openwiki.brief.info': "Обсяг і пріоритети. OpenWiki читає це й не переписує під час звичайних запусків.",
  'settings.openwiki.format.label': "Структура й формат (FORMAT.md)",
  'settings.openwiki.format.info': "Структура, розділи та правила сторінок wiki. Діаграми за замовчуванням у Mermaid.",
  'settings.openwiki.section.prompts': "Активні підказки",
  'settings.openwiki.section.references': "Довідкові документи",
  'settings.openwiki.section.parse': "Аналіз і об’єднання",
  'settings.openwiki.reset.label': "Скинути до типових",
  'settings.openwiki.reset.confirm': "Замінити активний бриф і формат вбудованими типовими (спрощена китайська + Mermaid)?",
  'settings.openwiki.references.dropTitle': "Перетягніть довідкові документи сюди",
  'settings.openwiki.references.typeHint': "Дозволено: .md, .doc, .docx. Краще текст; описуйте діаграми кодом, а не зображеннями.",
  'settings.openwiki.references.limitHint': "До 10 файлів. Понад 10МБ — підтвердження; понад 50МБ — відхилення.",
  'settings.openwiki.references.pickFiles': "Вибрати файли",
  'settings.openwiki.references.pickFolder': "Вибрати теку",
  'settings.openwiki.references.browse': "Огляд…",
  'settings.openwiki.references.empty': "Довідкові документи ще не імпортовано.",
  'settings.openwiki.references.remove': "Вилучити",
  'settings.openwiki.references.confirmLarge': "Один або кілька файлів більші за 10МБ. Продовжити імпорт?",
  'settings.openwiki.references.confirmFolderCount': "Знайдено {count} відповідних файлів. Продовжити з першими 10?",
  'settings.openwiki.references.desktopOnly': "Рідний вибір файлів доступний у програмі для робочого столу.",
  'settings.openwiki.references.readFailed': "Не вдалося прочитати вибраний файл.",
  'settings.openwiki.references.folderEmpty': "У цій теці не знайдено файлів .md, .doc або .docx.",
  'settings.openwiki.parse.info': "Аналіз використовує ту саму модель Wiki, що й Generate. Створює чернетку й не змінює активні підказки, доки ви не об’єднаєте.",
  'settings.openwiki.parse.label': "Проаналізувати довідкові документи",
  'settings.openwiki.parse.running': "Аналіз довідкових документів…",
  'settings.openwiki.parse.failed': "Не вдалося проаналізувати довідкові документи.",
  'settings.openwiki.parse.modelRequired': "Перед аналізом виберіть модель Wiki.",
  'settings.openwiki.merge.label': "Об’єднати чернетку з активними підказками",
  'settings.openwiki.draft.title': "Проаналізована чернетка",
  'settings.openwiki.draft.brief': "Чернетка брифу",
  'settings.openwiki.draft.format': "Чернетка формату",
  'settings.openwiki.draft.empty': "Чернетки ще немає. Спочатку проаналізуйте довідкові документи.",
} as const;
