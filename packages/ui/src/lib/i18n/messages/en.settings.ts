export const settingsDict = {
  ...
  'settings.page.openwiki.description': 'Generate and maintain a project wiki with OpenWiki, using your OpenCode model.',
  'settings.openwiki.section.general': 'General',
  'settings.openwiki.section.format': 'Document format',
  'settings.openwiki.section.prompts': 'Active prompts',
  'settings.openwiki.section.references': 'Reference documents',
  'settings.openwiki.section.parse': 'Parse and merge',
  'settings.openwiki.enabled.label': 'Show Wiki surface',
  'settings.openwiki.enabled.info': 'When off, the Wiki entry is hidden from the context rail.',
  'settings.openwiki.autoReveal.label': 'Open Wiki after jobs',
  'settings.openwiki.autoReveal.info': 'After a successful generate or update, open the Wiki surface.',
  'settings.openwiki.language.label': 'Wiki language',
  'settings.openwiki.language.info': 'Optional BCP-47 locale passed to OpenWiki (for example zh-CN).',
  'settings.openwiki.model.label': 'Wiki model',
  'settings.openwiki.model.info': 'Defaults to the current OpenCode selection. Override with another logged-in model.',
  'settings.openwiki.model.followCurrent': 'Same as current OpenCode model',
  'settings.openwiki.model.current': 'Current OpenCode model: {model}',
  'settings.openwiki.model.none': 'None selected',
  'settings.openwiki.noProject': 'Open a project to edit wiki brief and format files.',
  'settings.openwiki.preset.label': 'Format preset',
  'settings.openwiki.preset.info': 'Applying a preset replaces the brief and format editors.',
  'settings.openwiki.preset.apply': 'Apply preset',
  'settings.openwiki.preset.openwiki-default': 'OpenWiki default',
  'settings.openwiki.preset.architecture-module': 'Architecture + modules',
  'settings.openwiki.preset.api-service': 'API / service',
  'settings.openwiki.preset.custom': 'Custom',
  'settings.openwiki.brief.label': 'Brief (INSTRUCTIONS.md)',
  'settings.openwiki.brief.info': 'Scope and priorities for wiki generation. OpenWiki reads this and does not rewrite it on normal runs.',
  'settings.openwiki.format.label': 'Structure & format (FORMAT.md)',
  'settings.openwiki.format.info': 'Required pages, sections, and writing conventions for generated wiki pages. Diagrams default to Mermaid.',
  'settings.openwiki.reset.label': 'Reset to defaults',
  'settings.openwiki.reset.confirm': 'Replace the active brief and format with the built-in defaults (Simplified Chinese + Mermaid)?',
  'settings.openwiki.references.dropTitle': 'Drop reference documents here',
  'settings.openwiki.references.typeHint': 'Accepted types: .md, .doc, .docx. Prefer text-only docs; describe diagrams in code rather than embedding images.',
  'settings.openwiki.references.limitHint': 'Up to 10 files. Files over 10MB ask for confirmation; files over 50MB are rejected.',
  'settings.openwiki.references.pickFiles': 'Choose files',
  'settings.openwiki.references.pickFolder': 'Choose folder',
  'settings.openwiki.references.browse': 'Browse…',
  'settings.openwiki.references.empty': 'No reference documents imported yet.',
  'settings.openwiki.references.remove': 'Remove',
  'settings.openwiki.references.confirmLarge': 'One or more files are larger than 10MB. Continue importing?',
  'settings.openwiki.references.confirmFolderCount': 'Found {count} matching files. Continue with up to the first 10?',
  'settings.openwiki.references.desktopOnly': 'Native file picking is available in the desktop app.',
  'settings.openwiki.references.readFailed': 'Could not read the selected file.',
  'settings.openwiki.references.folderEmpty': 'No .md, .doc, or .docx files were found in that folder.',
  'settings.openwiki.parse.info': 'Parse uses the same Wiki model as Generate. It builds a draft brief/format from your reference documents without changing the active prompts until you merge.',
  'settings.openwiki.parse.label': 'Parse reference documents',
  'settings.openwiki.parse.running': 'Parsing reference documents…',
  'settings.openwiki.parse.failed': 'Failed to parse reference documents.',
  'settings.openwiki.parse.modelRequired': 'Select a Wiki model before parsing.',
  'settings.openwiki.merge.label': 'Merge draft into active prompts',
  'settings.openwiki.draft.title': 'Parsed draft',
  'settings.openwiki.draft.brief': 'Draft brief',
  'settings.openwiki.draft.format': 'Draft format',
  'settings.openwiki.draft.empty': 'No draft yet. Parse reference documents to create one.',
} as const;
