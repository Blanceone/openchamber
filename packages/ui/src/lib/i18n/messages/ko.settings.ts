export const settingsDict = {
  ...
  'settings.page.openwiki.description': "OpenCode에서 선택한 모델로 OpenWiki 프로젝트 Wiki를 생성하고 유지합니다.",
  'settings.openwiki.section.general': "일반",
  'settings.openwiki.section.format': "문서 형식",
  'settings.openwiki.enabled.label': "Wiki 표면 표시",
  'settings.openwiki.enabled.info': "끄면 컨텍스트 레일에서 Wiki가 숨겨집니다.",
  'settings.openwiki.autoReveal.label': "작업 후 Wiki 열기",
  'settings.openwiki.autoReveal.info': "생성 또는 업데이트가 성공하면 Wiki 표면을 엽니다.",
  'settings.openwiki.language.label': "Wiki 언어",
  'settings.openwiki.language.info': "OpenWiki에 전달할 선택적 BCP-47 로케일(예: ko).",
  'settings.openwiki.model.label': "Wiki 모델",
  'settings.openwiki.model.info': "기본값은 현재 OpenCode 선택입니다. 로그인한 다른 모델로 바꿀 수 있습니다.",
  'settings.openwiki.model.followCurrent': "현재 OpenCode 모델과 동일",
  'settings.openwiki.model.current': "현재 OpenCode 모델: {model}",
  'settings.openwiki.model.none': "선택 없음",
  'settings.openwiki.noProject': "Wiki brief와 형식을 편집하려면 프로젝트를 여세요.",
  'settings.openwiki.preset.label': "형식 프리셋",
  'settings.openwiki.preset.info': "프리셋을 적용하면 brief와 형식 텍스트가 바뀝니다.",
  'settings.openwiki.preset.apply': "프리셋 적용",
  'settings.openwiki.preset.openwiki-default': "OpenWiki 기본",
  'settings.openwiki.preset.architecture-module': "아키텍처 + 모듈",
  'settings.openwiki.preset.api-service': "API / service",
  'settings.openwiki.preset.custom': "사용자 지정",
  'settings.openwiki.brief.label': "Brief (INSTRUCTIONS.md)",
  'settings.openwiki.brief.info': "생성 범위와 우선순위. 일반 실행에서 OpenWiki는 이를 다시 쓰지 않습니다.",
  'settings.openwiki.format.label': "구조 및 형식 (FORMAT.md)",
  'settings.openwiki.format.info': "생성된 wiki 페이지의 구조, 섹션, 작성 규칙입니다. 다이어그램은 기본으로 Mermaid를 사용합니다.",
  'settings.openwiki.section.prompts': "현재 프롬프트",
  'settings.openwiki.section.references': "참고 문서",
  'settings.openwiki.section.parse': "파싱 및 병합",
  'settings.openwiki.reset.label': "기본값으로 재설정",
  'settings.openwiki.reset.confirm': "현재 브리프와 형식을 기본값(간체 중국어 + Mermaid)으로 바꿀까요?",
  'settings.openwiki.references.dropTitle': "참고 문서를 여기에 놓으세요",
  'settings.openwiki.references.typeHint': "지원 형식: .md, .doc, .docx. 텍스트 위주 문서를 권장하며, 다이어그램은 이미지 대신 코드로 표현하세요.",
  'settings.openwiki.references.limitHint': "최대 10개. 10MB 초과는 확인, 50MB 초과는 거부됩니다.",
  'settings.openwiki.references.pickFiles': "파일 선택",
  'settings.openwiki.references.pickFolder': "폴더 선택",
  'settings.openwiki.references.browse': "찾아보기…",
  'settings.openwiki.references.empty': "가져온 참고 문서가 없습니다.",
  'settings.openwiki.references.remove': "제거",
  'settings.openwiki.references.confirmLarge': "10MB보다 큰 파일이 있습니다. 계속 가져올까요?",
  'settings.openwiki.references.confirmFolderCount': "일치하는 파일 {count}개를 찾았습니다. 처음 10개까지 계속할까요?",
  'settings.openwiki.references.desktopOnly': "네이티브 파일 선택은 데스크톱 앱에서 사용할 수 있습니다.",
  'settings.openwiki.references.readFailed': "선택한 파일을 읽을 수 없습니다.",
  'settings.openwiki.references.folderEmpty': "해당 폴더에 .md, .doc, .docx 파일이 없습니다.",
  'settings.openwiki.parse.info': "파싱은 Generate와 같은 Wiki 모델을 사용합니다. 참고 문서로 초안을 만들며, 병합 전까지 현재 프롬프트를 바꾸지 않습니다.",
  'settings.openwiki.parse.label': "참고 문서 파싱",
  'settings.openwiki.parse.running': "참고 문서를 파싱하는 중…",
  'settings.openwiki.parse.failed': "참고 문서 파싱에 실패했습니다.",
  'settings.openwiki.parse.modelRequired': "파싱 전에 Wiki 모델을 선택하세요.",
  'settings.openwiki.merge.label': "초안을 현재 프롬프트에 병합",
  'settings.openwiki.draft.title': "파싱된 초안",
  'settings.openwiki.draft.brief': "초안 브리프",
  'settings.openwiki.draft.format': "초안 형식",
  'settings.openwiki.draft.empty': "초안이 없습니다. 참고 문서를 먼저 파싱하세요.",
} as const;
