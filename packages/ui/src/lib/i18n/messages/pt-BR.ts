...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.wiki.description': "Navegar e gerar o OpenWiki do projeto",
  'openwiki.panel.title': "OpenWiki",
  'openwiki.action.settings': "Configurações",
  'openwiki.action.cancel': "Cancelar",
  'openwiki.action.generate': "Gerar wiki",
  'openwiki.action.update': "Atualizar",
  'openwiki.action.regenerate': "Regenerar",
  'openwiki.action.confirmRegenerate': "Confirmar regeneração",
  'openwiki.consent.required': "O conteúdo wiki existente precisa da sua aprovação primeiro.",
  'openwiki.consent.explanation': "Este projeto já tem arquivos parecidos com wiki. Escolha adotar, fazer backup e reconstruir, ou cancelar.",
  'openwiki.consent.adopt': "Adotar no local",
  'openwiki.consent.backupRebuild': "Backup e reconstruir",
  'openwiki.empty.tree': "Ainda não há páginas wiki.",
  'openwiki.empty.page': "Selecione uma página para visualizar.",
  'openwiki.status.generating': "Gerando wiki…",
  'openwiki.error.modelRequired': "Selecione um modelo no compositor primeiro.",
  'openwiki.error.noProviderLogin': "Não há login OpenCode utilizável para o provedor \"{provider}\". Conecte-o em Configurações → Provedores ou escolha outro modelo.",
  'openwiki.error.opencodeLoginRequired': "Este modelo OpenCode/Zen ainda não está disponível para o OpenWiki. Conecte o OpenCode Zen com uma chave de API, escolha um modelo OpenCode gratuito ou um provedor de API com login (Anthropic, OpenAI, OpenRouter, …).",
  'openwiki.error.providerUnsupported': "O provedor \"{provider}\" não está disponível para o OpenWiki. Escolha outro modelo com login.",
  'openwiki.error.readUnsupported': "A leitura de arquivos não está disponível neste runtime.",
  'openwiki.ownership.absent': "Não gerado",
  'openwiki.ownership.openchamber-managed': "Gerenciado",
  'openwiki.ownership.foreign': "Wiki existente",
  'openwiki.ownership.conflict': "Conflito",
  'openwiki.stage.queued': "Na fila",
  'openwiki.stage.preparing': "Preparando",
  'openwiki.stage.mapping-model': "Mapeando modelo",
  'openwiki.stage.running': "Em execução",
  'openwiki.stage.writing': "Gravando",
  'openwiki.stage.completed': "Concluído",
  'openwiki.stage.failed': "Falhou",
  'openwiki.stage.cancelled': "Cancelado",
  'openwiki.action.exportDocx': "Exportar Word",
  'openwiki.export.preparing': "Preparando exportação para Word…",
  'openwiki.export.writing': "Gravando {count} arquivos Word…",
  'openwiki.export.done': "{count} arquivos Word exportados.",
  'openwiki.export.failed': "Falha ao exportar para Word.",
};
