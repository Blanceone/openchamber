...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.wiki.description': "瀏覽並產生專案 OpenWiki",
  'openwiki.panel.title': "OpenWiki",
  'openwiki.action.settings': "設定",
  'openwiki.action.cancel': "取消",
  'openwiki.action.generate': "產生 Wiki",
  'openwiki.action.update': "增量更新",
  'openwiki.action.regenerate': "重新產生",
  'openwiki.action.confirmRegenerate': "確認重新產生",
  'openwiki.consent.required': "偵測到既有 Wiki 內容，需要先取得你的同意。",
  'openwiki.consent.explanation': "專案中已有類似 Wiki 的檔案。請選擇就地接管、備份後重建，或取消。",
  'openwiki.consent.adopt': "就地接管",
  'openwiki.consent.backupRebuild': "備份後重建",
  'openwiki.empty.tree': "尚無 Wiki 頁面。",
  'openwiki.empty.page': "選擇頁面以預覽。",
  'openwiki.status.generating': "正在產生 Wiki…",
  'openwiki.error.modelRequired': "請先在對話中選擇模型。",
  'openwiki.error.noProviderLogin': "提供者「{provider}」沒有可用的 OpenCode 登入。請在設定 → 提供者中連線，或改選其他模型。",
  'openwiki.error.opencodeLoginRequired': "目前 OpenCode/Zen 模型尚無法用於 OpenWiki。請連線具 API 金鑰的 OpenCode Zen、改選免費檔 OpenCode 模型，或改選已登入的 API 提供者（Anthropic、OpenAI、OpenRouter 等）。",
  'openwiki.error.providerUnsupported': "提供者「{provider}」尚不支援 OpenWiki。請改選其他已登入模型。",
  'openwiki.error.readUnsupported': "目前執行環境無法讀取檔案。",
  'openwiki.ownership.absent': "尚未產生",
  'openwiki.ownership.openchamber-managed': "已託管",
  'openwiki.ownership.foreign': "既有 Wiki",
  'openwiki.ownership.conflict': "衝突",
  'openwiki.stage.queued': "排隊中",
  'openwiki.stage.preparing': "準備中",
  'openwiki.stage.mapping-model': "對應模型",
  'openwiki.stage.running': "執行中",
  'openwiki.stage.writing': "寫入中",
