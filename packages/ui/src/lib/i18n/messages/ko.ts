...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.wiki.description': "프로젝트 OpenWiki 탐색 및 생성",
  'openwiki.panel.title': "OpenWiki",
  'openwiki.action.settings': "설정",
  'openwiki.action.cancel': "취소",
  'openwiki.action.generate': "Wiki 생성",
  'openwiki.action.update': "업데이트",
  'openwiki.action.regenerate': "재생성",
  'openwiki.action.confirmRegenerate': "재생성 확인",
  'openwiki.consent.required': "기존 Wiki 내용이 있어 먼저 동의가 필요합니다.",
  'openwiki.consent.explanation': "이 프로젝트에 이미 Wiki 형태의 파일이 있습니다. 그대로 인수, 백업 후 재구축, 또는 취소를 선택하세요.",
  'openwiki.consent.adopt': "그대로 인수",
  'openwiki.consent.backupRebuild': "백업 후 재구축",
  'openwiki.empty.tree': "아직 Wiki 페이지가 없습니다.",
  'openwiki.empty.page': "미리볼 페이지를 선택하세요.",
  'openwiki.status.generating': "Wiki 생성 중…",
  'openwiki.error.modelRequired': "먼저 작성기에서 모델을 선택하세요.",
  'openwiki.error.noProviderLogin': "제공자 \"{provider}\"에 사용할 수 있는 OpenCode 로그인이 없습니다. 설정 → 제공자에서 연결하거나 다른 모델을 선택하세요.",
  'openwiki.error.opencodeLoginRequired': "이 OpenCode/Zen 모델은 아직 OpenWiki에서 사용할 수 없습니다. API 키가 있는 OpenCode Zen을 연결하거나, 무료 OpenCode 모델 또는 로그인한 API 제공자(Anthropic, OpenAI, OpenRouter 등)를 선택하세요.",
  'openwiki.error.providerUnsupported': "제공자 \"{provider}\"는 OpenWiki에서 아직 사용할 수 없습니다. 로그인한 다른 모델을 선택하세요.",
  'openwiki.error.readUnsupported': "이 런타임에서는 파일을 읽을 수 없습니다.",
  'openwiki.ownership.absent': "미생성",
  'openwiki.ownership.openchamber-managed': "관리됨",
  'openwiki.ownership.foreign': "기존 Wiki",
  'openwiki.ownership.conflict': "충돌",
  'openwiki.stage.queued': "대기 중",
  'openwiki.stage.preparing': "준비 중",
  'openwiki.stage.mapping-model': "모델 매핑",
  'openwiki.stage.running': "실행 중",
  'openwiki.stage.writing': "쓰는 중",
  'openwiki.stage.completed': "완료",
  'openwiki.stage.failed': "실패",
  'openwiki.stage.cancelled': "취소됨",
  'openwiki.action.exportDocx': "Word 내보내기",
  'openwiki.export.preparing': "Word 내보내기 준비 중…",
  'openwiki.export.writing': "Word 파일 {count}개를 쓰는 중…",
  'openwiki.export.done': "Word 파일 {count}개를 내보냈습니다.",
  'openwiki.export.failed': "Word 내보내기에 실패했습니다.",
};
