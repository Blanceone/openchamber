...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.wiki.description': "Переглядайте й створюйте OpenWiki проєкту",
  'openwiki.panel.title': "OpenWiki",
  'openwiki.action.settings': "Налаштування",
  'openwiki.action.cancel': "Скасувати",
  'openwiki.action.generate': "Створити wiki",
  'openwiki.action.update': "Оновити",
  'openwiki.action.regenerate': "Перестворити",
  'openwiki.action.confirmRegenerate': "Підтвердити перестворення",
  'openwiki.consent.required': "Наявний вміст wiki спочатку потребує вашої згоди.",
  'openwiki.consent.explanation': "У проєкті вже є файли, схожі на wiki. Оберіть прийняти, резервну копію й перебудову або скасувати.",
  'openwiki.consent.adopt': "Прийняти як є",
  'openwiki.consent.backupRebuild': "Резервна копія й перебудова",
  'openwiki.empty.tree': "Сторінок wiki ще немає.",
  'openwiki.empty.page': "Виберіть сторінку для перегляду.",
  'openwiki.status.generating': "Генерація wiki…",
  'openwiki.error.modelRequired': "Спочатку виберіть модель у композиторі.",
  'openwiki.error.noProviderLogin': "Немає придатного входу OpenCode для постачальника «{provider}». Підключіть його в Параметри → Постачальники або оберіть іншу модель.",
  'openwiki.error.opencodeLoginRequired': "Ця модель OpenCode/Zen ще недоступна для OpenWiki. Підключіть OpenCode Zen з API-ключем, оберіть безкоштовну модель OpenCode або постачальника API з увімкненим входом (Anthropic, OpenAI, OpenRouter, …).",
  'openwiki.error.providerUnsupported': "Постачальник «{provider}» недоступний для OpenWiki. Оберіть іншу модель з увімкненим входом.",
  'openwiki.error.readUnsupported': "Читання файлів недоступне в цьому середовищі.",
  'openwiki.ownership.absent': "Не створено",
  'openwiki.ownership.openchamber-managed': "Кероване",
  'openwiki.ownership.foreign': "Існуюче wiki",
  'openwiki.ownership.conflict': "Конфлікт",
  'openwiki.stage.queued': "У черзі",
  'openwiki.stage.preparing': "Підготовка",
  'openwiki.stage.mapping-model': "Відповідність моделі",
  'openwiki.stage.running': "Виконується",
  'openwiki.stage.writing': "Запис",
