...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.wiki.description': "Przeglądaj i generuj OpenWiki projektu",
  'openwiki.panel.title': "OpenWiki",
  'openwiki.action.settings': "Ustawienia",
  'openwiki.action.cancel': "Anuluj",
  'openwiki.action.generate': "Generuj wiki",
  'openwiki.action.update': "Aktualizuj",
  'openwiki.action.regenerate': "Wygeneruj ponownie",
  'openwiki.action.confirmRegenerate': "Potwierdź ponowne generowanie",
  'openwiki.consent.required': "Istniejąca treść wiki wymaga najpierw Twojej zgody.",
  'openwiki.consent.explanation': "Projekt ma już pliki podobne do wiki. Wybierz przejęcie, kopię zapasową i przebudowę albo anuluj.",
  'openwiki.consent.adopt': "Przejmij w miejscu",
  'openwiki.consent.backupRebuild': "Kopia i przebudowa",
  'openwiki.empty.tree': "Brak stron wiki.",
  'openwiki.empty.page': "Wybierz stronę do podglądu.",
  'openwiki.status.generating': "Generowanie wiki…",
  'openwiki.error.modelRequired': "Najpierw wybierz model w kompozytorze.",
  'openwiki.error.noProviderLogin': "Brak użytecznego logowania OpenCode dla dostawcy „{provider}”. Połącz go w Ustawienia → Dostawcy albo wybierz inny model.",
  'openwiki.error.opencodeLoginRequired': "Ten model OpenCode/Zen nie jest jeszcze dostępny dla OpenWiki. Połącz OpenCode Zen z kluczem API, wybierz darmowy model OpenCode albo zalogowanego dostawcę API (Anthropic, OpenAI, OpenRouter, …).",
  'openwiki.error.providerUnsupported': "Dostawca „{provider}” nie jest dostępny dla OpenWiki. Wybierz inny zalogowany model.",
  'openwiki.error.readUnsupported': "Odczyt plików jest niedostępny w tym środowisku.",
  'openwiki.ownership.absent': "Nie wygenerowano",
  'openwiki.ownership.openchamber-managed': "Zarządzane",
  'openwiki.ownership.foreign': "Istniejące wiki",
  'openwiki.ownership.conflict': "Konflikt",
  'openwiki.stage.queued': "W kolejce",
  'openwiki.stage.preparing': "Przygotowanie",
  'openwiki.stage.mapping-model': "Mapowanie modelu",
  'openwiki.stage.running': "Działa",
  'openwiki.stage.writing': "Zapisywanie",
