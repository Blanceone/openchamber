export const settingsDict = {
  ...
  'settings.page.openwiki.description': "使用 OpenWiki 生成并维护项目 Wiki，复用你在 OpenCode 中选择的模型。",
  'settings.openwiki.section.general': "常规",
  'settings.openwiki.section.format': "文档格式",
  'settings.openwiki.enabled.label': "显示 Wiki 面板",
  'settings.openwiki.enabled.info': "关闭后，右侧栏不再显示 Wiki 入口。",
  'settings.openwiki.autoReveal.label': "任务完成后打开 Wiki",
  'settings.openwiki.autoReveal.info': "生成或更新成功后自动打开 Wiki 面板。",
  'settings.openwiki.language.label': "Wiki 语言",
  'settings.openwiki.language.info': "可选的 BCP-47 语言代码（例如 zh-CN），会传给 OpenWiki。",
  'settings.openwiki.model.label': "Wiki 模型",
  'settings.openwiki.model.info': "默认跟随当前 OpenCode 所选模型；也可改选其他已登录模型。",
  'settings.openwiki.model.followCurrent': "与当前 OpenCode 模型相同",
  'settings.openwiki.model.current': "当前 OpenCode 模型：{model}",
  'settings.openwiki.model.none': "未选择",
  'settings.openwiki.noProject': "请先打开项目，才能编辑 Wiki brief 与格式文件。",
  'settings.openwiki.preset.label': "格式预设",
  'settings.openwiki.preset.info': "应用预设会用预设内容替换 brief 与格式编辑器中的文本。",
  'settings.openwiki.preset.apply': "应用预设",
  'settings.openwiki.preset.openwiki-default': "OpenWiki 默认",
  'settings.openwiki.preset.architecture-module': "架构 + 模块",
  'settings.openwiki.preset.api-service': "API / 服务",
  'settings.openwiki.preset.custom': "自定义",
  'settings.openwiki.brief.label': "简介（INSTRUCTIONS.md）",
  'settings.openwiki.brief.info': "Wiki 生成的范围与优先级。OpenWiki 会读取此文件，正常运行不会改写它。",
  'settings.openwiki.format.label': "结构与格式（FORMAT.md）",
  'settings.openwiki.format.info': "生成 wiki 页面所需的结构、章节与写作约定。流程图等默认使用 Mermaid。",
  'settings.openwiki.section.prompts': "当前提示词",
  'settings.openwiki.section.references': "参考文档",
  'settings.openwiki.section.parse': "解析与合并",
  'settings.openwiki.reset.label': "恢复默认",
  'settings.openwiki.reset.confirm': "用内置默认提示词（简体中文 + Mermaid）替换当前简报与格式？",
  'settings.openwiki.references.dropTitle': "将参考文档拖放到此处",
  'settings.openwiki.references.typeHint': "支持 .md / .doc / .docx。请优先纯文本文档；流程图请用代码描述，不要嵌入图片。",
  'settings.openwiki.references.limitHint': "最多 10 个文件。超过 10MB 需确认，超过 50MB 将被拒绝。",
  'settings.openwiki.references.pickFiles': "选择文件",
  'settings.openwiki.references.pickFolder': "选择文件夹",
  'settings.openwiki.references.browse': "浏览…",
  'settings.openwiki.references.empty': "尚未导入参考文档。",
  'settings.openwiki.references.remove': "移除",
  'settings.openwiki.references.confirmLarge': "有文件大于 10MB。仍要继续导入吗？",
  'settings.openwiki.references.confirmFolderCount': "找到 {count} 个匹配文件。是否继续导入前 10 个？",
  'settings.openwiki.references.desktopOnly': "原生文件选择仅在桌面应用中可用。",
  'settings.openwiki.references.readFailed': "无法读取所选文件。",
  'settings.openwiki.references.folderEmpty': "该文件夹中未找到 .md、.doc 或 .docx 文件。",
  'settings.openwiki.parse.info': "解析使用与 Generate 相同的 Wiki 模型。会根据参考文档生成草案，在你合并前不会改动当前提示词。",
  'settings.openwiki.parse.label': "解析参考文档",
  'settings.openwiki.parse.running': "正在解析参考文档…",
  'settings.openwiki.parse.failed': "解析参考文档失败。",
  'settings.openwiki.parse.modelRequired': "请先选择 Wiki 模型再解析。",
  'settings.openwiki.merge.label': "将草案合并到当前提示词",
  'settings.openwiki.draft.title': "解析草案",
  'settings.openwiki.draft.brief': "草案简报",
  'settings.openwiki.draft.format': "草案格式",
  'settings.openwiki.draft.empty': "尚无草案。请先解析参考文档。",
} as const;
