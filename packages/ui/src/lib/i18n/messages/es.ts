...
export const dict: Record<I18nKey, string> = {
  ...
  'contextPanel.mode.wiki': "Wiki",
  'contextRail.surface.wiki.description': "Explorar y generar el OpenWiki del proyecto",
  'openwiki.panel.title': "OpenWiki",
  'openwiki.action.settings': "Ajustes",
  'openwiki.action.cancel': "Cancelar",
  'openwiki.action.generate': "Generar wiki",
  'openwiki.action.update': "Actualizar",
  'openwiki.action.regenerate': "Regenerar",
  'openwiki.action.confirmRegenerate': "Confirmar regeneración",
  'openwiki.consent.required': "El contenido wiki existente requiere tu aprobación primero.",
  'openwiki.consent.explanation': "Este proyecto ya tiene archivos tipo wiki. Elige adoptar, respaldar y reconstruir, o cancelar.",
  'openwiki.consent.adopt': "Adoptar en el sitio",
  'openwiki.consent.backupRebuild': "Respaldar y reconstruir",
  'openwiki.empty.tree': "Aún no hay páginas wiki.",
  'openwiki.empty.page': "Selecciona una página para previsualizar.",
  'openwiki.status.generating': "Generando wiki…",
  'openwiki.error.modelRequired': "Selecciona primero un modelo en el compositor.",
  'openwiki.error.noProviderLogin': "No hay un inicio de sesión de OpenCode usable para el proveedor «{provider}». Conéctalo en Ajustes → Proveedores o elige otro modelo.",
  'openwiki.error.opencodeLoginRequired': "Este modelo OpenCode/Zen aún no está disponible para OpenWiki. Conecta OpenCode Zen con una clave API, elige un modelo OpenCode gratuito o un proveedor API con sesión (Anthropic, OpenAI, OpenRouter, …).",
  'openwiki.error.providerUnsupported': "El proveedor «{provider}» no está disponible para OpenWiki. Elige otro modelo con sesión iniciada.",
  'openwiki.error.readUnsupported': "La lectura de archivos no está disponible en este entorno.",
  'openwiki.ownership.absent': "Sin generar",
  'openwiki.ownership.openchamber-managed': "Gestionado",
  'openwiki.ownership.foreign': "Wiki existente",
  'openwiki.ownership.conflict': "Conflicto",
  'openwiki.stage.queued': "En cola",
  'openwiki.stage.preparing': "Preparando",
  'openwiki.stage.mapping-model': "Asignando modelo",
  'openwiki.stage.running': "En ejecución",
  'openwiki.stage.writing': "Escribiendo",
  'openwiki.stage.completed': "Completado",
  'openwiki.stage.failed': "Fallido",
  'openwiki.stage.cancelled': "Cancelado",
  'openwiki.action.exportDocx': "Exportar Word",
  'openwiki.export.preparing': "Preparando exportación a Word…",
  'openwiki.export.writing': "Escribiendo {count} archivos Word…",
  'openwiki.export.done': "Se exportaron {count} archivos Word.",
  'openwiki.export.failed': "Error al exportar a Word.",
};
