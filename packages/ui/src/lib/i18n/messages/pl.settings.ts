export const settingsDict = {
  ...
  'settings.page.openwiki.description': "Twórz i utrzymuj wiki projektu przez OpenWiki, używając modelu OpenCode.",
  'settings.openwiki.section.general': "Ogólne",
  'settings.openwiki.section.format': "Format dokumentu",
  'settings.openwiki.enabled.label': "Pokaż powierzchnię Wiki",
  'settings.openwiki.enabled.info': "Gdy wyłączone, Wiki jest ukryte na szynie kontekstu.",
  'settings.openwiki.autoReveal.label': "Otwórz Wiki po zadaniach",
  'settings.openwiki.autoReveal.info': "Po udanym generowaniu lub aktualizacji otwórz powierzchnię Wiki.",
  'settings.openwiki.language.label': "Język wiki",
  'settings.openwiki.language.info': "Opcjonalne locale BCP-47 dla OpenWiki (np. pl).",
  'settings.openwiki.model.label': "Model wiki",
  'settings.openwiki.model.info': "Domyślnie bieżący wybór OpenCode. Możesz wybrać inny zalogowany model.",
  'settings.openwiki.model.followCurrent': "Tak jak bieżący model OpenCode",
  'settings.openwiki.model.current': "Bieżący model OpenCode: {model}",
  'settings.openwiki.model.none': "Nie wybrano",
  'settings.openwiki.noProject': "Otwórz projekt, aby edytować brief i format wiki.",
  'settings.openwiki.preset.label': "Preset formatu",
  'settings.openwiki.preset.info': "Zastosowanie presetu zastępuje brief i format.",
  'settings.openwiki.preset.apply': "Zastosuj preset",
  'settings.openwiki.preset.openwiki-default': "Domyślny OpenWiki",
  'settings.openwiki.preset.architecture-module': "Architektura + moduły",
  'settings.openwiki.preset.api-service': "API / service",
  'settings.openwiki.preset.custom': "Własny",
  'settings.openwiki.brief.label': "Brief (INSTRUCTIONS.md)",
  'settings.openwiki.brief.info': "Zakres i priorytety. OpenWiki czyta to i nie przepisuje przy zwykłych uruchomieniach.",
  'settings.openwiki.format.label': "Struktura i format (FORMAT.md)",
  'settings.openwiki.format.info': "Wymagana struktura, sekcje i konwencje stron wiki. Diagramy domyślnie w Mermaid.",
  'settings.openwiki.section.prompts': "Aktywne monity",
  'settings.openwiki.section.references': "Dokumenty referencyjne",
  'settings.openwiki.section.parse': "Analiza i scalanie",
  'settings.openwiki.reset.label': "Przywróć domyślne",
  'settings.openwiki.reset.confirm': "Zastąpić aktywny brief i format wbudowanymi domyślnymi (chiński uproszczony + Mermaid)?",
  'settings.openwiki.references.dropTitle': "Upuść dokumenty referencyjne tutaj",
  'settings.openwiki.references.typeHint': "Dozwolone: .md, .doc, .docx. Preferuj tekst; diagramy opisuj kodem zamiast osadzać obrazy.",
  'settings.openwiki.references.limitHint': "Maks. 10 plików. Powyżej 10MB potwierdzenie; powyżej 50MB odrzucenie.",
  'settings.openwiki.references.pickFiles': "Wybierz pliki",
  'settings.openwiki.references.pickFolder': "Wybierz folder",
  'settings.openwiki.references.browse': "Przeglądaj…",
  'settings.openwiki.references.empty': "Nie zaimportowano jeszcze dokumentów referencyjnych.",
  'settings.openwiki.references.remove': "Usuń",
  'settings.openwiki.references.confirmLarge': "Co najmniej jeden plik przekracza 10MB. Kontynuować import?",
  'settings.openwiki.references.confirmFolderCount': "Znaleziono {count} pasujących plików. Kontynuować z pierwszymi 10?",
  'settings.openwiki.references.desktopOnly': "Natywny wybór plików jest dostępny w aplikacji desktopowej.",
  'settings.openwiki.references.readFailed': "Nie udało się odczytać wybranego pliku.",
  'settings.openwiki.references.folderEmpty': "W tym folderze nie znaleziono plików .md, .doc ani .docx.",
  'settings.openwiki.parse.info': "Analiza używa tego samego modelu Wiki co Generate. Tworzy wersję roboczą i nie zmienia aktywnych monitów, dopóki nie scalysz.",
  'settings.openwiki.parse.label': "Analizuj dokumenty referencyjne",
  'settings.openwiki.parse.running': "Analizowanie dokumentów referencyjnych…",
  'settings.openwiki.parse.failed': "Nie udało się przeanalizować dokumentów referencyjnych.",
  'settings.openwiki.parse.modelRequired': "Przed analizą wybierz model Wiki.",
  'settings.openwiki.merge.label': "Scal wersję roboczą z aktywnymi monitami",
  'settings.openwiki.draft.title': "Wersja robocza z analizy",
  'settings.openwiki.draft.brief': "Roboczy brief",
  'settings.openwiki.draft.format': "Roboczy format",
  'settings.openwiki.draft.empty': "Brak wersji roboczej. Najpierw przeanalizuj dokumenty referencyjne.",
};
