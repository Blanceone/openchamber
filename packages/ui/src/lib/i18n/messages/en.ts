...
export const dict = {
  ...
  'contextRail.surface.wiki.description': 'Browse and generate the project OpenWiki',
  'openwiki.panel.title': 'OpenWiki',
  'openwiki.action.settings': 'Settings',
  'openwiki.action.cancel': 'Cancel',
  'openwiki.action.generate': 'Generate wiki',
  'openwiki.action.update': 'Update',
  'openwiki.action.regenerate': 'Regenerate',
  'openwiki.action.confirmRegenerate': 'Confirm regenerate',
  'openwiki.action.exportDocx': 'Export Word',
  'openwiki.export.preparing': 'Preparing Word export…',
  'openwiki.export.writing': 'Writing {count} Word files…',
  'openwiki.export.done': 'Exported {count} Word files.',
  'openwiki.export.failed': 'Word export failed.',
  'openwiki.consent.required': 'Existing wiki content needs your approval first.',
  'openwiki.consent.explanation': 'This project already has wiki-like files. Choose adopt in place, backup then rebuild, or cancel.',
  'openwiki.consent.adopt': 'Adopt in place',
  'openwiki.consent.backupRebuild': 'Backup then rebuild',
  'openwiki.empty.tree': 'No wiki pages yet.',
  'openwiki.empty.page': 'Select a page to preview.',
  'openwiki.status.generating': 'Generating wiki…',
  'openwiki.error.modelRequired': 'Select a model in the composer first.',
  'openwiki.error.noProviderLogin': 'No usable OpenCode login for provider "{provider}". Connect it in Settings → Providers, or pick another model.',
  'openwiki.error.opencodeLoginRequired': 'This OpenCode/Zen model is not available for OpenWiki yet. Connect OpenCode Zen with an API key, pick a free-tier OpenCode model, or choose a logged-in API provider (Anthropic, OpenAI, OpenRouter, …).',
  'openwiki.error.providerUnsupported': 'Provider "{provider}" is not available for OpenWiki. Pick another logged-in model.',
  'openwiki.error.readUnsupported': 'File reading is not available in this runtime.',
  'openwiki.ownership.absent': 'Not generated',
  'openwiki.ownership.openchamber-managed': 'Managed',
  'openwiki.ownership.foreign': 'Existing wiki',
  'openwiki.ownership.conflict': 'Conflict',
  'openwiki.stage.queued': 'Queued',
  'openwiki.stage.preparing': 'Preparing',
  'openwiki.stage.mapping-model': 'Mapping model',
  'openwiki.stage.running': 'Running',
  'openwiki.stage.writing': 'Writing',
  'openwiki.stage.completed': 'Completed',
  'openwiki.stage.failed': 'Failed',
  'openwiki.stage.cancelled': 'Cancelled',
