export const settingsDict = {
  ...
  'settings.page.openwiki.description': "Gere e mantenha um wiki do projeto com o OpenWiki usando seu modelo do OpenCode.",
  'settings.openwiki.section.general': "Geral",
  'settings.openwiki.section.format': "Formato do documento",
  'settings.openwiki.enabled.label': "Mostrar superfície Wiki",
  'settings.openwiki.enabled.info': "Quando desligado, o Wiki fica oculto no trilho de contexto.",
  'settings.openwiki.autoReveal.label': "Abrir Wiki após tarefas",
  'settings.openwiki.autoReveal.info': "Após gerar ou atualizar com sucesso, abrir a superfície Wiki.",
  'settings.openwiki.language.label': "Idioma do wiki",
  'settings.openwiki.language.info': "Locale BCP-47 opcional para o OpenWiki (por exemplo pt-BR).",
  'settings.openwiki.model.label': "Modelo do wiki",
  'settings.openwiki.model.info': "O padrão segue a seleção atual do OpenCode. Você pode escolher outro modelo autenticado.",
  'settings.openwiki.model.followCurrent': "Igual ao modelo atual do OpenCode",
  'settings.openwiki.model.current': "Modelo atual do OpenCode: {model}",
  'settings.openwiki.model.none': "Nenhum selecionado",
  'settings.openwiki.noProject': "Abra um projeto para editar o brief e o formato do wiki.",
  'settings.openwiki.preset.label': "Predefinição de formato",
  'settings.openwiki.preset.info': "Aplicar uma predefinição substitui o brief e o formato.",
  'settings.openwiki.preset.apply': "Aplicar predefinição",
  'settings.openwiki.preset.openwiki-default': "Padrão OpenWiki",
  'settings.openwiki.preset.architecture-module': "Arquitetura + módulos",
  ...
  'settings.openwiki.brief.info': "Escopo e prioridades. O OpenWiki lê isto e não o reescreve em execuções normais.",
  'settings.openwiki.format.label': "Estrutura e formato (FORMAT.md)",
  'settings.openwiki.format.info': "Estrutura, seções e convenções das páginas wiki. Diagramas usam Mermaid por padrão.",
  'settings.openwiki.section.prompts': "Prompts ativos",
  'settings.openwiki.section.references': "Documentos de referência",
  'settings.openwiki.section.parse': "Analisar e mesclar",
  'settings.openwiki.reset.label': "Restaurar padrões",
  'settings.openwiki.reset.confirm': "Substituir o brief e o formato ativos pelos padrões internos (chinês simplificado + Mermaid)?",
  'settings.openwiki.references.dropTitle': "Solte os documentos de referência aqui",
  'settings.openwiki.references.typeHint': "Tipos aceitos: .md, .doc, .docx. Prefira texto; descreva diagramas em código em vez de embutir imagens.",
  'settings.openwiki.references.limitHint': "Até 10 arquivos. Acima de 10MB pede confirmação; acima de 50MB são rejeitados.",
  'settings.openwiki.references.pickFiles': "Escolher arquivos",
  'settings.openwiki.references.pickFolder': "Escolher pasta",
  'settings.openwiki.references.browse': "Procurar…",
  'settings.openwiki.references.empty': "Nenhum documento de referência importado ainda.",
  'settings.openwiki.references.remove': "Remover",
  'settings.openwiki.references.confirmLarge': "Um ou mais arquivos têm mais de 10MB. Continuar a importação?",
  'settings.openwiki.references.confirmFolderCount': "Foram encontrados {count} arquivos correspondentes. Continuar com os 10 primeiros?",
  'settings.openwiki.references.desktopOnly': "A seleção nativa de arquivos está disponível no aplicativo para desktop.",
  'settings.openwiki.references.readFailed': "Não foi possível ler o arquivo selecionado.",
  'settings.openwiki.references.folderEmpty': "Nenhum arquivo .md, .doc ou .docx foi encontrado nessa pasta.",
  'settings.openwiki.parse.info': "A análise usa o mesmo modelo Wiki do Generate. Cria um rascunho sem alterar os prompts ativos até você mesclar.",
  'settings.openwiki.parse.label': "Analisar documentos de referência",
  'settings.openwiki.parse.running': "Analisando documentos de referência…",
  'settings.openwiki.parse.failed': "Falha ao analisar os documentos de referência.",
  'settings.openwiki.parse.modelRequired': "Selecione um modelo Wiki antes de analisar.",
  'settings.openwiki.merge.label': "Mesclar rascunho nos prompts ativos",
  'settings.openwiki.draft.title': "Rascunho analisado",
  'settings.openwiki.draft.brief': "Brief do rascunho",
  'settings.openwiki.draft.format': "Formato do rascunho",
  'settings.openwiki.draft.empty': "Ainda não há rascunho. Analise documentos de referência para criar um.",
} as const;
