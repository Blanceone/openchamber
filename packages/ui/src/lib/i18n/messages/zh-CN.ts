...
export const dict: Record<I18nKey, string> = {
  ...
  'contextRail.surface.wiki.description': "浏览并生成项目 OpenWiki",
  'openwiki.panel.title': "OpenWiki",
  'openwiki.action.settings': "设置",
  'openwiki.action.cancel': "取消",
  'openwiki.action.generate': "生成 Wiki",
  'openwiki.action.update': "增量更新",
  'openwiki.action.regenerate': "重新生成",
  'openwiki.action.confirmRegenerate': "确认重新生成",
  'openwiki.consent.required': "检测到已有 Wiki 内容，需要先征得你的同意。",
  'openwiki.consent.explanation': "项目中已有类似 Wiki 的文件。请选择就地接管、备份后重建，或取消。",
  'openwiki.consent.adopt': "就地接管",
  'openwiki.consent.backupRebuild': "备份后重建",
  'openwiki.empty.tree': "还没有 Wiki 页面。",
  'openwiki.empty.page': "选择页面以预览。",
  'openwiki.status.generating': "正在生成 Wiki…",
  'openwiki.error.modelRequired': "请先在对话中选择模型。",
  'openwiki.error.noProviderLogin': "提供商「{provider}」没有可用的 OpenCode 登录。请在设置 → 提供商中连接，或改选其他模型。",
  'openwiki.error.opencodeLoginRequired': "当前 OpenCode/Zen 模型尚不可用于 OpenWiki。请连接带 API Key 的 OpenCode Zen、改选免费档 OpenCode 模型，或改选已登录的 API 提供商（Anthropic、OpenAI、OpenRouter 等）。",
  'openwiki.error.providerUnsupported': "提供商「{provider}」暂不支持 OpenWiki。请改选其他已登录模型。",
  'openwiki.error.readUnsupported': "当前运行时无法读取文件。",
  'openwiki.ownership.absent': "尚未生成",
  'openwiki.ownership.openchamber-managed': "已托管",
  'openwiki.ownership.foreign': "已有 Wiki",
  'openwiki.ownership.conflict': "冲突",
  'openwiki.stage.queued': "排队中",
  'openwiki.stage.preparing': "准备中",
  'openwiki.stage.mapping-model': "映射模型",
  'openwiki.stage.running': "运行中",
  'openwiki.stage.writing': "写入中",
  'openwiki.stage.completed': "已完成",
  'openwiki.stage.failed': "失败",
  'openwiki.stage.cancelled': "已取消",
  'openwiki.action.exportDocx': "导出 Word",
  'openwiki.export.preparing': "正在准备 Word 导出…",
  'openwiki.export.writing': "正在写入 {count} 个 Word 文件…",
  'openwiki.export.done': "已导出 {count} 个 Word 文件。",
  'openwiki.export.failed': "Word 导出失败。",
};
