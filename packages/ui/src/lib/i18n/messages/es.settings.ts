export const settingsDict = {
  ...
  'settings.page.openwiki.title': "OpenWiki",
  'settings.page.openwiki.description': "Genera y mantén un wiki del proyecto con OpenWiki usando tu modelo de OpenCode.",
  'settings.openwiki.section.general': "General",
  'settings.openwiki.section.format': "Formato del documento",
  'settings.openwiki.enabled.label': "Mostrar superficie Wiki",
  'settings.openwiki.enabled.info': "Si está desactivado, Wiki se oculta del rail de contexto.",
  'settings.openwiki.autoReveal.label': "Abrir Wiki tras trabajos",
  'settings.openwiki.autoReveal.info': "Tras generar o actualizar con éxito, abrir la superficie Wiki.",
  'settings.openwiki.language.label': "Idioma del wiki",
  'settings.openwiki.language.info': "Locale BCP-47 opcional para OpenWiki (por ejemplo es).",
  'settings.openwiki.model.label': "Modelo del wiki",
  'settings.openwiki.model.info': "Por defecto usa la selección actual de OpenCode. Puedes elegir otro modelo con sesión iniciada.",
  'settings.openwiki.model.followCurrent': "Igual que el modelo actual de OpenCode",
  'settings.openwiki.model.current': "Modelo actual de OpenCode: {model}",
  'settings.openwiki.model.none': "Ninguno seleccionado",
  'settings.openwiki.noProject': "Abre un proyecto para editar el brief y el formato del wiki.",
  'settings.openwiki.preset.label': "Plantilla de formato",
  'settings.openwiki.preset.info': "Aplicar una plantilla reemplaza el brief y el formato.",
  'settings.openwiki.preset.apply': "Aplicar plantilla",
  'settings.openwiki.preset.openwiki-default': "Predeterminado de OpenWiki",
  'settings.openwiki.preset.architecture-module': "Arquitectura + módulos",
  'settings.openwiki.preset.api-service': "API / servicio",
  'settings.openwiki.preset.custom': "Personalizado",
  'settings.openwiki.brief.label': "Brief (INSTRUCTIONS.md)",
  'settings.openwiki.brief.info': "Alcance y prioridades. OpenWiki lo lee y no lo reescribe en ejecuciones normales.",
  'settings.openwiki.format.label': "Estructura y formato (FORMAT.md)",
  'settings.openwiki.format.info': "Estructura, secciones y convenciones para las páginas wiki. Los diagramas usan Mermaid por defecto.",
  'settings.openwiki.section.prompts': "Indicaciones activas",
  'settings.openwiki.section.references': "Documentos de referencia",
  'settings.openwiki.section.parse': "Analizar y fusionar",
  'settings.openwiki.reset.label': "Restablecer valores predeterminados",
  'settings.openwiki.reset.confirm': "¿Reemplazar el resumen y el formato activos por los valores predeterminados (chino simplificado + Mermaid)?",
  'settings.openwiki.references.dropTitle': "Suelte aquí los documentos de referencia",
  'settings.openwiki.references.typeHint': "Tipos admitidos: .md, .doc, .docx. Prefiera texto; describa diagramas en código en lugar de incrustar imágenes.",
  'settings.openwiki.references.limitHint': "Hasta 10 archivos. Más de 10MB pide confirmación; más de 50MB se rechazan.",
  'settings.openwiki.references.pickFiles': "Elegir archivos",
  'settings.openwiki.references.pickFolder': "Elegir carpeta",
  'settings.openwiki.references.browse': "Examinar…",
  'settings.openwiki.references.empty': "Aún no hay documentos de referencia importados.",
  'settings.openwiki.references.remove': "Quitar",
  'settings.openwiki.references.confirmLarge': "Uno o más archivos superan 10MB. ¿Continuar la importación?",
  'settings.openwiki.references.confirmFolderCount': "Se encontraron {count} archivos coincidentes. ¿Continuar con los primeros 10?",
  'settings.openwiki.references.desktopOnly': "La selección nativa de archivos está disponible en la aplicación de escritorio.",
  'settings.openwiki.references.readFailed': "No se pudo leer el archivo seleccionado.",
  'settings.openwiki.references.folderEmpty': "No se encontraron archivos .md, .doc o .docx en esa carpeta.",
  'settings.openwiki.parse.info': "El análisis usa el mismo modelo Wiki que Generate. Crea un borrador sin cambiar las indicaciones activas hasta que fusione.",
  'settings.openwiki.parse.label': "Analizar documentos de referencia",
  'settings.openwiki.parse.running': "Analizando documentos de referencia…",
  'settings.openwiki.parse.failed': "Error al analizar los documentos de referencia.",
  'settings.openwiki.parse.modelRequired': "Seleccione un modelo Wiki antes de analizar.",
  'settings.openwiki.merge.label': "Fusionar borrador en las indicaciones activas",
  'settings.openwiki.draft.title': "Borrador analizado",
  'settings.openwiki.draft.brief': "Resumen del borrador",
  'settings.openwiki.draft.format': "Formato del borrador",
  'settings.openwiki.draft.empty': "Aún no hay borrador. Analice documentos de referencia para crear uno.",
} as const;
