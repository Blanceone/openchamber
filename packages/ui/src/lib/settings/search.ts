...
const SETTINGS_SEARCH_ITEMS: readonly SettingsSearchItem[] = [
  ...
  },
  {
    ...
    descriptionKey: 'settings.openwiki.brief.info',
    keywords: ['instructions', 'brief', 'INSTRUCTIONS.md'],
  },
  {
    id: 'openwiki.format',
    page: 'openwiki',
    titleKey: 'settings.openwiki.format.label',
    descriptionKey: 'settings.openwiki.format.info',
    keywords: ['format', 'structure', 'FORMAT.md', 'mermaid'],
  },
  {
    id: 'openwiki.references',
    page: 'openwiki',
    titleKey: 'settings.openwiki.section.references',
    descriptionKey: 'settings.openwiki.references.typeHint',
    keywords: ['reference', 'docx', 'import wiki docs'],
  },
  {
    id: 'openwiki.draft-brief',
    page: 'openwiki',
    titleKey: 'settings.openwiki.draft.brief',
    keywords: ['parse', 'draft', 'merge'],
  },
  {
