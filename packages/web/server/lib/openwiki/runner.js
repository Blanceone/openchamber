...
import { buildOpenWikiGatewayChildEnv, parseModelRef } from './model-bridge.js';
...
export const startOpenWikiJob = async (input) => {
  ...
  if (input.command === 'init' && classification.ownership === 'openchamber-managed' && classification.wikiExists) {
